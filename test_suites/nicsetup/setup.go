...
func TestSetup(t *imagetest.TestWorkflow) error {
	...
	if *vmtype != "multi" {
		...
		ipv6VM1.AddCustomNetworkWithStackType(network1, ipv6Subnetwork1, "IPV6_ONLY")
	...
	if *vmtype != "single" {
		...
		network2, err := t.CreateNetwork("network2", false)
		if err != nil {
			return err
		}
		...
		ipv4dual.AddCustomNetworkWithStackType(network2, dualstackSubnetwork2, "IPV4_IPV6")

		ipv4ipv6.AddCustomNetworkWithStackType(network1, ipv4Subnetwork1, "IPV4_ONLY")
		ipv4ipv6.AddCustomNetworkWithStackType(network2, ipv6Subnetwork2, "IPV6_ONLY")

		dualipv4.AddCustomNetworkWithStackType(network1, dualstackSubnetwork1, "IPV4_IPV6")
		dualipv4.AddCustomNetworkWithStackType(network2, ipv4Subnetwork2, "IPV4_ONLY")

		dualdual.AddCustomNetworkWithStackType(network1, dualstackSubnetwork1, "IPV4_IPV6")
		dualdual.AddCustomNetworkWithStackType(network2, dualstackSubnetwork2, "IPV4_IPV6")

		dualipv6.AddCustomNetworkWithStackType(network1, dualstackSubnetwork1, "IPV4_IPV6")
		dualipv6.AddCustomNetworkWithStackType(network2, ipv6Subnetwork2, "IPV6_ONLY")

		ipv6ipv4.AddCustomNetworkWithStackType(network1, ipv6Subnetwork1, "IPV6_ONLY")
		ipv6ipv4.AddCustomNetworkWithStackType(network2, ipv4Subnetwork2, "IPV4_ONLY")

		ipv6dual.AddCustomNetworkWithStackType(network1, ipv6Subnetwork1, "IPV6_ONLY")
		ipv6dual.AddCustomNetworkWithStackType(network2, dualstackSubnetwork2, "IPV4_IPV6")

		ipv6ipv6.AddCustomNetworkWithStackType(network1, ipv6Subnetwork1, "IPV6_ONLY")
		ipv6ipv6.AddCustomNetworkWithStackType(network2, ipv6Subnetwork2, "IPV6_ONLY")
