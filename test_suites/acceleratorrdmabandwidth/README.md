# Accelerator Image Test Suite: AcceleratorRDMABandwidth

This is a test suite for Accelerator Images to test RDMA bandwidth performance
and verify that the RDMA NIC can approach the line rate.
