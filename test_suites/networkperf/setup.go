...
var networkPerfTestConfig = []networkPerfTest{
	...
	},
	{
		...
		arch:        "X86_64",
		networks:    []string{"DEFAULT"},
		quota:       &daisy.QuotaAvailable{Metric: "CPUS", Units: 64, Region: "us-central1"},
		zone:        "us-central1-a",
	},
	{
		name:        "n4-80",
		...
		arch:        "X86_64",
		networks:    []string{"DEFAULT"},
		quota:       &daisy.QuotaAvailable{Metric: "CPUS", Units: 320, Region: "us-central1"},
		zone:        "us-central1-a",
	},
	{
		name:        "c4-2",
		...
		arch:        "X86_64",
		networks:    []string{"DEFAULT"},
		quota:       &daisy.QuotaAvailable{Metric: "CPUS", Units: 8, Region: "us-central1"},
	},
	{
		name:        "c4-192",
		zone:        "us-central1-a",
		...
		arch:        "X86_64",
		networks:    []string{"DEFAULT", "TIER_1"},
		quota:       &daisy.QuotaAvailable{Metric: "CPUS", Units: 1152, Region: "us-central1"},
	},
}
