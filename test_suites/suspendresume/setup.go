...
func TestSetup(t *imagetest.TestWorkflow) error {
	if !strings.Contains(t.Image.Name, "rhel-8-2-sap") && !strings.Contains(t.Image.Name, "rhel-8-1-sap") && !strings.Contains(t.Image.Name, "debian-10") && !strings.Contains(t.Image.Family, "ubuntu-pro-1804-lts-arm64") && !strings.Contains(t.Image.Family, "ubuntu-2404-lts") {
