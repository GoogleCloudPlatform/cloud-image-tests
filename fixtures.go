...
// again.
//
// There are limitations setting machine types. See
// https://cloud.google.com/compute/docs/instances/changing-machine-type-of-stopped-instance#limitations
func (t *TestVM) RebootChangeMachineType(machineType string) error {
	...
	if err := t.testWorkflow.wf.AddDependency(changeVMStep, waitStopStep); err != nil {
		return err
	}
